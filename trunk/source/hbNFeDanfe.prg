****************************************************************************************************
* Funcoes e Classes Relativas a Impressao Danfe PDF                                                *
...
LOCAL cIde, cEmit, cDest, cRetirada, cEntrega, cICMSTotal, cISSTotal, cRetTrib, ;
   ...
   ::aIde[ "dSaiEnt" ] := hbNFe_PegaDadosXML("dSaiEnt", cIde )
   ...
   TRY
      ::cTelefoneEmitente := TRANSF(::oFuncoes:eliminaString(ALLTRIM(hbNFe_PegaDadosXML("fone", cEmit )),"()- ,.+"),"@R (99) 99999-9999")
   CATCH
      ::cTelefoneEmitente := ""
   END
...
METHOD geraPDF() CLASS hbNFeDanfe
   ...
   ::cFile := ::ohbNFe:pastaPDF+"\"+::cChave+".pdf"
...
METHOD destinatario() CLASS hbNFeDanfe
   ...
   ELSE
      ...
      hbNFe_Texto_Hpdf( ::oPdfPage,521, ::nLinhaPdf-5  , 589, Nil, SUBS(::aIde[ "dEmi" ],9,2)+"/"+SUBS(::aIde[ "dEmi" ],6,2)+"/"+SUBS(::aIde[ "dEmi" ],1,4) , HPDF_TALIGN_CENTER, Nil, ::oPdfFontCabecalho, 10 )
      ...
      TRY
         hbNFe_Texto_Hpdf( ::oPdfPage,521, ::nLinhaPdf-5  , 589, Nil, SUBS(::aIde[ "dSaiEnt" ],9,2)+"/"+SUBS(::aIde[ "dSaiEnt" ],6,2)+"/"+SUBS(::aIde[ "dSaiEnt" ],1,4) , HPDF_TALIGN_CENTER, Nil, ::oPdfFontCabecalho, 10 )
      CATCH
      END
      ...
      hbNFe_Texto_Hpdf( ::oPdfPage,521, ::nLinhaPdf-5  , 589, Nil, TIME() , HPDF_TALIGN_CENTER, Nil, ::oPdfFontCabecalho, 10 )
      ...
      IF ::lPaisagem = .T. // paisagem
         ...
         DO WHILE AT("<dup>", cDups) > 0
            ...
            IF !EMPTY(cNumero)
               ...
               cValor := ALLTRIM(::oFuncoes:ponto(VAL(hbNFe_PegaDadosXML("vDup", cDup )),13,2))
            ELSE
               nColuna --
               EXIT
            ENDIF
...
METHOD dadosImposto() CLASS hbNFeDanfe
   IF ::nFolha = 1
      IF ::lPaisagem = .T. // paisagem
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,71, ::nLinhaPdf-5  , 149, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vBC" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR ICMS
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,216, ::nLinhaPdf-5  , 349, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vICMS" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,351, ::nLinhaPdf-5  , 514, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vBCST" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR ICMS ST
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,516, ::nLinhaPdf-5  , 649, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vST" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,651, ::nLinhaPdf-5  , 8299, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vProd" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,71, ::nLinhaPdf-5  ,185, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vFrete" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR DO SEGURO
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,187, ::nLinhaPdf-5  , 301, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vSeg" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // DESCONTO
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,303, ::nLinhaPdf-5  , 417, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vDesc" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // OUTRAS DESP. ACESSO.
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,419, ::nLinhaPdf-5  , 533, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vOutro" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR DO IPI
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,535, ::nLinhaPdf-5  , 649, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vIPI" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR TOTAL DA NF
         hbNFe_Box_Hpdf( ::oPdfPage,650, ::nLinhaPdf-16, 180, 16, ::nLarguraBox )
         hbNFe_Texto_Hpdf( ::oPdfPage,651, ::nLinhaPdf-1  , 829, Nil, "VALOR TOTAL DA NOTA FISCAL" , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 5 )
         hbNFe_Texto_Hpdf( ::oPdfPage,651, ::nLinhaPdf-5  , 829, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vNF" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
      ...
      ELSE
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,6, ::nLinhaPdf-5  , 114, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vBC" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR ICMS
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,116, ::nLinhaPdf-5  , 214, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vICMS" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // BASE DE CALCULO DO ICMS ST
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,216, ::nLinhaPdf-5  , 344, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vBCST" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR ICMS ST
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,346, ::nLinhaPdf-5  , 444, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vST" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR TOTAL DOS PRODUTOS
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf-5  , 589, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vProd" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,6, ::nLinhaPdf-5  , 92, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vFrete" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR DO SEGURO
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,94, ::nLinhaPdf-5  , 180, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vSeg" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // DESCONTO
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,182, ::nLinhaPdf-5  , 268, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vDesc" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // OUTRAS DESP. ACESSO.
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,270, ::nLinhaPdf-5  , 356, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vOutro" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR DO IPI
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,358, ::nLinhaPdf-5  , 444, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vIPI" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // VALOR TOTAL DA NF
         hbNFe_Box_Hpdf( ::oPdfPage,445, ::nLinhaPdf-16, 145, 16, ::nLarguraBox )
         hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf-1  , 589, Nil, "VALOR TOTAL DA NOTA FISCAL" , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 5 )
         hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf-5  , 589, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aICMSTotal[ "vNF" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
   ...
   IF ::nFolha = 1
      IF ::lPaisagem = .T. // paisagem
        ...
        ENDIF
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,71, ::nLinhaPdf-5  ,199, Nil, ::aTransp[ "qVol" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 8 )
         // ESPECIE
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,571, ::nLinhaPdf-5  , 699, Nil, ::aTransp[ "pesoB" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // PESO LÍQUIDO
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,701, ::nLinhaPdf-5  , 829, Nil, ::aTransp[ "pesoL" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
      ...
      ELSE
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,6, ::nLinhaPdf-5  , 99, Nil, ::aTransp[ "qVol" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 8 )
         // ESPECIE
         ...
         hbNFe_Texto_Hpdf( ::oPdfPage,401, ::nLinhaPdf-5  , 499, Nil, ::aTransp[ "pesoB" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         // PESO LÍQUIDO
         hbNFe_Box_Hpdf( ::oPdfPage,500, ::nLinhaPdf-16, 90, 16, ::nLarguraBox )
         hbNFe_Texto_Hpdf( ::oPdfPage,501, ::nLinhaPdf-1  , 589, Nil, "PESO LÍQUIDO" , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 5 )
         hbNFe_Texto_Hpdf( ::oPdfPage,501, ::nLinhaPdf-5  , 589, Nil, ::aTransp[ "pesoL" ] , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
...
LOCAL nLinhaFinalProd, nTamanhoProd, nItem, nIdes
   ...
   DO WHILE .T.
      ...
      IF ::lPaisagem = .T. // paisagem
         ...
         // QUANT.
         hbNFe_Texto_Hpdf( ::oPdfPage,451, ::nLinhaPdf  , 489, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "qCom" ]),15,::nCasasQtd)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // VALOR UNITARIO
         hbNFe_Texto_Hpdf( ::oPdfPage,491, ::nLinhaPdf  , 534, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vUnCom" ]),15,::nCasasVUn)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // VALOR LÍQUIDO
         hbNFe_Texto_Hpdf( ::oPdfPage,536, ::nLinhaPdf  , 579, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vProd" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // BC ICMS
         hbNFe_Texto_Hpdf( ::oPdfPage,581, ::nLinhaPdf  , 624, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vBC" ]<>Nil,::aItemICMS[ "vBC" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // VALOR ICMS
         hbNFe_Texto_Hpdf( ::oPdfPage,626, ::nLinhaPdf  , 664, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vICMS" ]<>Nil,::aItemICMS[ "vICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // BC ICMS ST
         hbNFe_Texto_Hpdf( ::oPdfPage,666, ::nLinhaPdf  , 709, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vBCST" ]<>Nil,::aItemICMS[ "vBCST" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // VALOR ICMS ST
         hbNFe_Texto_Hpdf( ::oPdfPage,711, ::nLinhaPdf  , 749, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vICMSST" ]<>Nil,::aItemICMS[ "vICMSST" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // VALOR IPI
           hbNFe_Texto_Hpdf( ::oPdfPage,751, ::nLinhaPdf  , 789, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "vIPI" ]<>Nil,::aItemIPI[ "vIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // ALIQ ICMS
         hbNFe_Texto_Hpdf( ::oPdfPage,791, ::nLinhaPdf  , 809, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "pICMS" ]<>Nil,::aItemICMS[ "pICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         // ALIQ IPI
           hbNFe_Texto_Hpdf( ::oPdfPage,811, ::nLinhaPdf  , 829, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "pIPI" ]<>Nil,::aItemIPI[ "pIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
         ::nLinhaPdf -= 6
      ...
      ELSE
         IF ::lValorDesc = .F. // Layout Padrão
             ...
             // QUANT.
             hbNFe_Texto_Hpdf( ::oPdfPage,296, ::nLinhaPdf  , 334, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "qCom" ]),15,::nCasasQtd)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 5 )
             // VALOR UNITARIO
             hbNFe_Texto_Hpdf( ::oPdfPage,336, ::nLinhaPdf  , 379, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vUnCom" ]),15,::nCasasVUn)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR LÍQUIDO
             hbNFe_Texto_Hpdf( ::oPdfPage,381, ::nLinhaPdf  , 424, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vProd" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // BC ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,426, ::nLinhaPdf  , 469, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vBC" ]<>Nil,::aItemICMS[ "vBC" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,471, ::nLinhaPdf  , 509, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vICMS" ]<>Nil,::aItemICMS[ "vICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR IPI
               hbNFe_Texto_Hpdf( ::oPdfPage,511, ::nLinhaPdf  , 549, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "vIPI" ]<>Nil,::aItemIPI[ "vIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // ALIQ ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,551, ::nLinhaPdf  , 569, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "pICMS" ]<>Nil,::aItemICMS[ "pICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // ALIQ IPI
               hbNFe_Texto_Hpdf( ::oPdfPage,571, ::nLinhaPdf  , 589, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "pIPI" ]<>Nil,::aItemIPI[ "pIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             ::nLinhaPdf -= 6
          ...
          ELSE
            ...
            ELSE
             ...
             hbNFe_Texto_Hpdf( ::oPdfPage,276, ::nLinhaPdf  , 294, Nil, ::aItem[ "uCom" ] , HPDF_TALIGN_CENTER, Nil, ::oPdfFontCabecalho, 6 )
             // QUANT.
             hbNFe_Texto_Hpdf( ::oPdfPage,296, ::nLinhaPdf  , 329, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "qCom" ]),15,::nCasasQtd)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 5 )
             // VALOR UNITARIO
             hbNFe_Texto_Hpdf( ::oPdfPage,331, ::nLinhaPdf  , 369, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vUnCom" ]),15,::nCasasVUn)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR LÍQUIDO
             hbNFe_Texto_Hpdf( ::oPdfPage,371, ::nLinhaPdf  , 409, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vProd" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR DESCONTO
             TRY
                hbNFe_Texto_Hpdf( ::oPdfPage,411, ::nLinhaPdf  , 444, Nil, ALLTRIM(::oFuncoes:ponto(VAL(::aItem[ "vDesc" ]),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             CATCH
                hbNFe_Texto_Hpdf( ::oPdfPage,411, ::nLinhaPdf  , 444, Nil, ALLTRIM(::oFuncoes:ponto(VAL('0.00'),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             END
             // BC ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf  , 484, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vBC" ]<>Nil,::aItemICMS[ "vBC" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,486, ::nLinhaPdf  , 519, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "vICMS" ]<>Nil,::aItemICMS[ "vICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // VALOR IPI
               hbNFe_Texto_Hpdf( ::oPdfPage,521, ::nLinhaPdf  , 549, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "vIPI" ]<>Nil,::aItemIPI[ "vIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // ALIQ ICMS
             hbNFe_Texto_Hpdf( ::oPdfPage,551, ::nLinhaPdf  , 569, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemICMS[ "pICMS" ]<>Nil,::aItemICMS[ "pICMS" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
             // ALIQ IPI
               hbNFe_Texto_Hpdf( ::oPdfPage,571, ::nLinhaPdf  , 589, Nil, ALLTRIM(::oFuncoes:ponto(VAL(IF(::aItemIPI[ "pIPI" ]<>Nil,::aItemIPI[ "pIPI" ],"0")),15,2)) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
   ...
   IF ::nFolha = 1
      IF VAL(IF(::aISSTotal[ "vServ" ]<>Nil,::aISSTotal[ "vServ" ],"0")) > 0 // com servico
         IF ::lPaisagem = .T. // paisagem
            ...
            hbNFe_Texto_Hpdf( ::oPdfPage,271, ::nLinhaPdf-5  , 459, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vServ" ]<>Nil,::aISSTotal[ "vServ" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
            // BASE DE CALC
            ...
            hbNFe_Texto_Hpdf( ::oPdfPage,461, ::nLinhaPdf-5  , 649, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vBC" ]<>Nil,::aISSTotal[ "vBC" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
            // VALOR DO ISSQN
            hbNFe_Box_Hpdf( ::oPdfPage,650, ::nLinhaPdf-16, 180, 16, ::nLarguraBox )
            hbNFe_Texto_Hpdf( ::oPdfPage,651, ::nLinhaPdf-1  , 829, Nil, "VALOR DO ISSQN" , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 5 )
            hbNFe_Texto_Hpdf( ::oPdfPage,651, ::nLinhaPdf-5  , 829, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vISS" ]<>Nil,::aISSTotal[ "vISS" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
         ...
         ELSE
            ...
            hbNFe_Texto_Hpdf( ::oPdfPage,156, ::nLinhaPdf-5  , 299, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vServ" ]<>Nil,::aISSTotal[ "vServ" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
            // BASE DE CALC
            ...
            hbNFe_Texto_Hpdf( ::oPdfPage,301, ::nLinhaPdf-5  , 444, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vBC" ]<>Nil,::aISSTotal[ "vBC" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
            // VALOR DO ISSQN
            hbNFe_Box_Hpdf( ::oPdfPage,445, ::nLinhaPdf-16, 145, 16, ::nLarguraBox )
            hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf-1  , 589, Nil, "VALOR DO ISSQN" , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 5 )
            hbNFe_Texto_Hpdf( ::oPdfPage,446, ::nLinhaPdf-5  , 589, Nil, ::oFuncoes:ponto(VAL(IF(::aISSTotal[ "vISS" ]<>Nil,::aISSTotal[ "vISS" ],"0")),15) , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 10 )
...
METHOD rodape() CLASS hbNFeDanfe
   IF ::lPaisagem = .T. // paisagem
      ...
      hbNFe_Texto_Hpdf( ::oPdfPage,185, ::nLinhaPdf  , 829, Nil, ::ohbNFE:cDesenvolvedor , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
   ELSE
      hbNFe_Texto_Hpdf( ::oPdfPage, 5, ::nLinhaPdf  , 110, Nil, "DATA DA IMPRESSÃO: "+DTOC(DATE()) , HPDF_TALIGN_LEFT, Nil, ::oPdfFontCabecalho, 6 )
      hbNFe_Texto_Hpdf( ::oPdfPage,115, ::nLinhaPdf  , 589, Nil, ::ohbNFE:cDesenvolvedor , HPDF_TALIGN_RIGHT, Nil, ::oPdfFontCabecalho, 6 )
   ENDIF
RETURN Nil
...
FUNCTION hbNFe_Texto_Hpdf( oPdfPage2, x1, y1, x2, y2, cText, align, Dummy, oFontePDF, nTamFonte, nAngulo)
LOCAL nRadiano
   #ifndef __XHARBOUR__
