...
METHOD NFEInutiliza( cUf, cAno, cCnpj, cMod, cSerie, cNumIni, cNumFim, cJustificativa, cCertificado ) CLASS SefazClass
   ...
   ::cVersao     := "2.00"
   ::cUf         := cUF
   ::cServico    := "http://www.portalfiscal.inf.br/nfe/..." // falta colocar
   ::cSoapAction := "http://www.portalfiscal.inf.br/nfe/..." // falta colocar
   ...
   ::cXmlDados   += [<infInut Id="] + /* FIDInutilizacao + */ [">] // falta colocar
   ::cXmlDados   += [<tpAmb>] + ::cAmbiente + [</tpAmb>]
...
METHOD CurlSoapPost()
   ...
   nStatus := curl_easy_getinfo( oCurl, HB_CURLINFO_RESPONSE_CODE )
   cXMLResp := ''
   IF nStatus = 200 // OK
