...
#define _EVENTO               9
#define _CONSULTACTEDEST      10
#define _DOWNLOADCTE          11
#define _RECPEVENTO           12

#define _MSXML2_DOMDocument          'MSXML2.DOMDocument.6.0'
#define _MSXML2_DOMDocument_Ass      'MSXML2.DOMDocument.5.0'
#define _MSXML2_MXDigitalSignature   'MSXML2.MXDigitalSignature.5.0'
#define _MSXML2_XMLSchemaCache       'MSXML2.XMLSchemaCache.6.0'
#define _MSXML2_ServerXMLHTTP        'MSXML2.ServerXMLHTTP.6.0'
...
#define HBCTE_EXIGIDA         .T.
#define HBCTE_NAOEXIGIDA      .F.
